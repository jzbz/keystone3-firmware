...
impl URType {
    pub fn from(type_str: &str) -> URResult<URType> {
        match type_str {
            ...
            "dcr-sign-request" => Ok(URType::DcrSignRequest(type_str.to_string())),
            "dcr-signed-tx" => Ok(URType::DcrSignedTx(type_str.to_string())),
    ...
    pub fn get_type_str(&self) -> String {
        match self {
            ...
            URType::DcrSignRequest(type_str) => type_str.to_string(),
            URType::DcrSignedTx(type_str) => type_str.to_string(),
        }
    }
}
...
// Decred
pub const DCR_SIGN_REQUEST: RegistryType = RegistryType("dcr-sign-request", Some(8701));
pub const DCR_SIGNED_TX: RegistryType = RegistryType("dcr-signed-tx", Some(8702));
